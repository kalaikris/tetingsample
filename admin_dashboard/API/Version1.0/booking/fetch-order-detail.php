...
include '../../../../web-app/php/objects/users-booking.php';
$users_booking = new UsersBooking();

include '../../../../web-app/php/objects/users-booking-detail.php';
$users_booking_detail = new UsersBookingDetail();

include '../../../../web-app/php/objects/users-booking-passenger.php';
$users_booking_passenger = new UsersBookingPassenger();

include '../../../../web-app/php/objects/users-booking-journey.php';
$users_booking_journey = new UsersBookingJourney();

include '../../../../web-app/php/objects/airport.php'; 
$airport = new Airport();
