...
if($stmt->rowCount()==1){
    $serviceBusinessType->businessTypeToken = $admin->generateToken('business_type','token');
    ...
    $stmtCheck = $serviceBusinessType->businessTypeAvailableCheck();
    if($stmtCheck->rowCount()==0){
        $serviceBusinessType->addBusinessType();
        $serviceBusinessType->addBusinessTypeAvailService();
        $serviceBusinessType->addBusinessTypeImages();
        $serviceBusinessType->addBusinessTypePartners();
        $serviceBusinessType->addBusinessTypeService();
        $obj->status_code = 201;
        $obj->title       = "Success";
