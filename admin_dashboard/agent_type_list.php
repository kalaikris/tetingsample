...
<body>
    ...
    <main class="main-contents">
        <section class="bg-white full-height" id="toggle3">
            <div class="header-details">
                <h1 class="header_main">Agent Type List</h1>
                <p class="total_emp total">Total Agent Type List - 2</p>
            </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h6>Agent Type Name</h6>
                        <input class="agenttypename" type="text" name="" placeholder="Hospital">
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="modal-footer">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-amety">
                        <h6>Agent Type Name</h6>
                        <input class="edit_agenttypename" type="text" name="" placeholder="Hospital">
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="modal-footer">
    ...
    function fetchagenttype(){
        ...
        data: json1
            ...
            $('.total').text(`Total Agent Type List - ${agenttypearray.length}`);
