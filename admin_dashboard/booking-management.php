    ...
    <main class="main-contents">
        <section class="bg-white full-height" id="toggle3">
            <div class="header-details">
                <h1 class="header_main">Booking Management</h1>
    ...
    <script>
        ...
        function fetchbookinghistory(fromdate,todate){
            ...
            let json1 = JSON.stringify(datas);
                    ...
                    dataType: "JSON",
                    type: "POST",
                    url: apiPath+"/booking/bookingManagement.php",
                    data: json1
                    }).done(function(data1) {
                        let bookingHistoryArray = data1.data;
                        $('.total').text(`Total Bookings - ${bookingHistoryArray.length}`)
                        console.log(bookingHistoryArray);
                        let bookinglist = '';
                        bookingHistoryArray.forEach((bookings,index) => {
                            let contactdetails = '';
                            ...
                            bookinglist += ` <tr>
                                                ...
                                                <td>${bookings.serviceToken}</td>
                                                <td>${bookings.serviceTypes}</td>
                                                <td>${bookings.bookingType}</td>
                                                <td>${bookings.airportCode} - ${bookings.airportName}</td>
