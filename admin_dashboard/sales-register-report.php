...
<body>
    ...
    <main class="main-contents">
        <section class="bg-white full-height" id="toggle3">
            <div class="header-details">
                <h1 class="header_main"> Sales Register Reports</h1>
                ...
                <table class="custom-table booking-manage" id="dataTables_filter">
                    <thead>
                        <tr>
                            ...
                            <th> Name on which invoice issued</th>
                            <th>Customer GST Number</th>
                            <th>Airportzo GST Number</th>
                            ...
                            <th>GST</th>
                            <th>sale value</th>
                            <th>Taxable Value of Markup</th>
                            <th>GST</th>
                            <th>Mrk Up Value (Post Discount)</th>
                            <th>Taxable value of agent conv fee</th>
                            <th>GST</th>
                            <th>Total Agent Con Fee</th>
                            <th>Total Taxable Value</th>
                            <th>Total GST</th>
                            <th>Total Invoice Value</th>
                            <th>Convinience fee</th>
                            <th>gst on convinience fee</th>
                            <th>Total Invoice value including Convenience fee</th>
                            <!-- <th>Razor Pay Refund ID</th> -->
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
    ...
    <script>
        ...
        function fetchsalesreport(fromdate,todate){
            ...
            let json1 = JSON.stringify(datas);
                    ...
                    dataType: "JSON",
                    type: "POST",
                    url: apiPath+"/reports/salesRegisterReport.php",
                    data: json1
                    }).done(function(data1) {
                        let salesReportArray = data1.report;
                        let reportlist = '';
                        salesReportArray.forEach((reports,index) => {
                            reportlist += `<tr>
                                            <td>${index + 1}</td>
                                            <td>${reports.invoiceNumber}</td>
                                            <td>${reports.nameOfInvoice}</td>
                                            <td>${reports.gstNumber}</td>
                                            <td>${reports.airportzo_gstNo}</td>
                                            <td>${reports.place_of_service}</td>
                                            <td>${reports.bookedDate}</td>
                                            <td>${reports.serviceDate}</td>
                                            <td>${reports.bookingRef}</td>
                                            <td>${reports.serviceRef}</td>
                                            <td>${reports.razorPayId}</td>
                                            <td>${reports.serviceDescription}</td>
                                            <td>${reports.hsnCode}</td>
                                            <td>${reports.taxableValue}</td>
                                            <td>${reports.gst}</td>
                                            <td>${reports.saleValue}</td>
                                            <td>${reports.markupAmount}</td>
                                            <td>${reports.markup_GST}</td>
                                            ...
                                            <td>${reports.total_tax_value}</td>
                                            <td>${reports.total_gst}</td>
                                            <td>${reports.total_invoice_value}</td>
