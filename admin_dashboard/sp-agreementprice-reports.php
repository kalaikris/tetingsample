    ...
    <main class="main-contents">
        <section class="bg-white full-height" id="toggle3">
            <div class="header-details">
                <h1 class="header_main">SP agreement price Reports</h1>
            ...
            let json1 = JSON.stringify(datas);
                    ...
                    data: json1
                        ...
                        revenueReportArray.forEach((reports,index) => {
                            reportlist += `<tr>
                                            <td valign="top">${slno += 1}</td>
                                            <td valign="top">${reports.providerCompany}</td>
                                            <td>${reports.businessType}</td>
                                            <td>Adult</td>
                                            <td>${reports.priceInclusiveGst.priceAdult}</td>
                                            <td>${reports.GST}</td>
                                          </tr>
                                          <tr>
                                            <td valign="top">${slno += 1}</td>
                                            ...
                                            <td>${reports.businessType}</td>
                                            <td>Child</td>
                                            <td>${reports.priceInclusiveGst.priceChildren}</td>
                                            <td>${reports.GST}</td>
                                          </tr>
                                          <tr>
                                            <td valign="top">${slno += 1}</td>
                                            ...
                                            <td>${reports.businessType}</td>
                                            <td>Additional Adult</td>
                                            <td>${reports.priceInclusiveGst.addPriceAdult}</td>
                                            <td>${reports.GST}</td>
                                          </tr>
                                          <tr>
                                            <td valign="top">${slno += 1}</td>
                                            ...
                                            <td>${reports.businessType}</td>
                                            <td>Additional Child</td>
                                            <td>${reports.priceInclusiveGst.addPriceChildren}</td>
                                            <td>${reports.GST}</td>
                                          </tr>`;
                        });
