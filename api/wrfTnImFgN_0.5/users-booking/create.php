...
$booking_type = $input_data->device_type;//'Android';
    ...
    if ($users_booking->stmt->rowCount() == 0) {
        ...
        if (property_exists($payment_order, 'status')) {
            if ($payment_order->status == "paid") {
                                ...
                                if ($service_coupon_arr[$i]->business_token == $category_arr[$j]->business_type_token) {
                                    ...
                                    if($category_arr[$j]->gst_type == "Incl Gst"){
                                        if ($category_arr[$j]->coupon_type == 'Percentage') {
                                            $discount_amt = (float) ($service_coupon_arr[$i]->total_amount) * $category_arr[$j]->dis_amt / 100;
                                            ...
                                            $discount_amt = (int) $category_arr[$j]->dis_amt * $category_arr[$j]->currency_value;
                                        ...
                                        if ($category_arr[$j]->coupon_type == 'Percentage') {
                                            ...
                                            $discount_amt = (int) $category_arr[$j]->dis_amt;
                                            $coupon_discount_amt += (int) $category_arr[$j]->dis_amt;
                                        }
                                    }
                                    ...
                                    $coupon_detail->coupon_percentage = $category_arr[$j]->dis_amt;
                ...
                // $payment_view = $price_data->total_cost;//$payment_order->amount / 100;
                if ($paid_amount == $total_price) {
                    ...
                    $users_booking->service_amount = $service_cost_excl_gst;
                    $users_booking->service_gst = $service_cost_gst;
                    $users_booking->convenience_fee = $convenience_cost;
                    ...
                    $users_booking->booking_type = $booking_type;
                    ...
                    $users_booking->description_two = '';
                    $users_booking->plink_id = '';
                    ...
                    $users_booking->plink_name = '';
                    $users_booking->plink_mobile = '';
                    $users_booking->plink_email = '';
                    $users_booking->plink_desc = '';
                    if ($coupon_token != 0) {
                    ...
                    if ($users_booking->create()) {
                        ...
                        $users_booking_detail->status = 'Pending';
                        $servic_key = 0;
                        foreach ($station_array as $station_key => $station_value) {
                            ...
                            foreach ($station_value->service_array as $service_value) {
                                ...
                                $users_booking_detail->adult_service_amount = $price_adult;
                                ...
                                $users_booking_detail->children_service_amount = $price_children;
                                ...
                                $users_booking_detail->net_amount = $net_amount;
                        ...
                        if ($fetch_order_detail->status_code == 200) {
                            ...
                            foreach ($sp_service_array as $sp_service_value) {
                                ...
                                //$source_path, $add_page PDF Creation
                        }
