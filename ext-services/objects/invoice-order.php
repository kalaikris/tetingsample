...
class InvoiceTemplateOrder {
    ...
    public function genInvoiceForOrder() {
        $invoice_html = '<table style="width:100%" cellspacing="0" cellpadding="0">
            <thead style="bgcolor: #fbfbfb;">
                <tr>
                    ...
                    <th style="">
                        ...
                        <br>
                        <span>
                            <span style="font-size:14px;">Invoice No : ' . $this->invoice_obj->id . ' | Date : ' . $this->invoice_obj->date_time . '</span>
                        </span>
                    </th>
                </tr>
                <tr>
            ...
            foreach ($this->invoice_obj->station_array as $order_value) {
                $invoice_html .= '<tr>
                    <td width="100%">
                        <div>
                            <table style="width:100%;" border="0" cellspacing="0" cellpadding="4">
                                ...
                                <tbody>';
                foreach ($order_value->service_array as $service_key => $service_value) {
                    $invoice_html .= '
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span style="font-size: 10px;">' . $service_value->service_provider->name . '</span>
                                            <br>
                                            <span style="font-size: 10px;">HSN Code: 996761</span>
                                        </td>
                                        <td>
                                            <span style="font-size: 12px;">' . $service_value->price_detail->adult_service_amount . '</span>
                                        </td>
                                        <td style="text-align:center;">
                                            <span style="font-size: 12px;">' . $service_value->price_detail->total_adult . '</span>
                                        </td>
                                        <td style="text-align:center;">
                                            <span style="font-size: 12px;">' . $service_value->price_detail->children_service_amount . '</span>
                                        </td>
                                        <td style="text-align:center;">
                                            <span style="font-size: 12px;">' . $service_value->price_detail->total_children . '</span>
                                        </td>
                                        <td style="text-align:center;">
                                            <span style="font-size: 12px;">' . $service_value->price_detail->net_amount . '</span>
                                        </td>
                                    </tr>';
                }
                unset($service_value);
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:40%;text-align:right;line-height:35px;">
                                                        <b style="font-size: 18px;">₹ ' . $this->invoice_obj->price_detail->total_amount . '</b>
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                    ...
                    <td>
                        <table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="https://airportzostage.in/invoince-template/airportzo-logo.png" alt="logo" style="width:180px;">
                                    </td>
                                    <td style="text-align:right;">
                                        <img src="https://airportzostage.in/invoince-template/signature.png" alt="logo" style="width:150px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
