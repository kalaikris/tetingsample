            ...
            <tr>
                <td>
                    <div style="max-width:600px;margin: 0 auto;box-sizing: border-box;padding: 24px;">
                        <p style="margin: 0 0 12px;">Hello <span style="font-weight: bold;">Jeffery Knight</span>,</p>
                        <p style="margin: 0 0 12px;">Descrption: <span>MAA Terminal - Departure - Silver package - 17 Oct 2022 01:00 PM</span></p>
                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td valign="center" style="width: 36px;padding-bottom: 24px;">
                                        <div style="margin-right: 12px;">
                                            <img src="mail.png" alt="" width="36" style="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td valign="center" style="width: 36px;padding-bottom: 24px;">
                                        <div style="margin-right: 12px;">
                                            <img src="call.png" alt="" width="36" style="">
                                        </div>
                                    </td>
                                    <td style="padding-bottom: 24px;">
                                        <div>
                                ...
                                <tr>
                                    <td valign="center" style="width: 36px;">
                                        <div style="margin-right: 12px;">
                                            <img src="watsapp.png" alt="" width="36" style="">
                                        </div>
                                    </td>
                                    <td>
                                        <div>
