		  ...
		  <tr>
		  	<td style="padding-bottom: 105px;border-bottom: 2px solid #e3e3e3;">
		  	  <div style="width: 82%;margin: 0 auto;">
		  	  	<p>Service Distributor ID : <span>W8352</span></p>
		  	  	<p>Created on : <span>01 Jul, 2022, 17:30(GMT+4)</span></p>
		  	  	<p>Hello <span style="font-weight: bold;">Sterlings</span>,</p>
		  	...
		  	<td style="background-color: #fff;padding-bottom: 40px;border-bottom: 2px solid #e3e3e3;">
		  		<div style="width:72%;background-color: #fff;border-radius: 12px;border:2px solid #e3e3e3;padding: 32px;margin: 0 auto;transform: translateY(-50%);">
			  	  <div style="display: flex;align-items: center;margin-bottom: 24px;">
			  	  	<img src="https://airportzo.net.in/mail-template/username.svg" alt="">
			  	  	<div style="margin-left: 20px;">
			  	  	  <p style="font-size:15px;margin-bottom: 0;margin-top: 0;">User Name</p>
			  	  	  <p style="font-size:22px;font-weight: bold;margin: 0;letter-spacing: 0.6px;">Sterling</p>
			  	  	</div>
			  	  </div>
			  	  <div style="display: flex;align-items: center;">
			  	  	<img src="https://airportzo.net.in/mail-template/password.svg" alt="">
			  	  	<div style="margin-left: 20px;">
			  	  	  <p style="font-size:15px;margin-bottom: 0;margin-top: 0;">Password</p>
			  	  	  <p style="font-size:22px;font-weight: bold;margin: 0;letter-spacing: 0.8px;">98BDe7w/</p>
			  	  	</div>
			  	  </div>
		  		</div>
				  ...
				  <a href="#" style="display: inline-block;width: 100%;max-width: 235px;background-color: #84BE40;text-decoration: none;text-align: center;border-radius: 12px;color: white;padding: 16px;font-weight: bold;">Login now</a>
			  	</div>
		  	</td>
		  </tr>
		</tbody>
		  ...
		  <tr>
		  	<td style="padding:32px 0;display: block;width: 82%;margin: 0 auto;">
		  	  <div style="width: 70%;display: flex;align-items: center;margin-bottom: 24px;padding-bottom: 20px;border-bottom:1px solid #e5e5e5;">
		  	  	<img src="https://airportzo.net.in/mail-template/mail.svg" alt="">
		  	  	<div style="margin-left: 20px;">
		  	  ...
		  	  <div style="width: 70%;display: flex;align-items: center;margin-bottom: 24px;padding-bottom: 20px;border-bottom:1px solid #e5e5e5;">
		  	  	<img src="https://airportzo.net.in/mail-template/call.svg" alt="">
		  	  	<div style="margin-left: 20px;">
		  	  ...
		  	  <div style="width: 70%;display: flex;align-items: center;margin-bottom: 24px;">
		  	  	<img src="https://airportzo.net.in/mail-template/watsapp.svg" alt="">
		  	  	<div style="margin-left: 20px;">
