...
if($stmtUser->rowCount()==1){
    ...
    //        //$onboard->password    = hash('sha512', $inputData->password);
            ...
            /////$onboard->distributorAirports = $inputData->distributorAirports;
            $onboard->gmDateTime          = $gm_date_time;
            //$onboard->distibutorToken     = $onboard->generateToken('service__distributor','token');
            ////update distributor details
            if ( $onboard->updateDistributor() ) {
//                ////create airports for distributor
//                ////backup function for old type
//                ///////$onboard->addDistributorAirports();
//                /////create business typw
                $onboard->addDistributorBusinessType();
                $onboard->addDistributorAirportsNew();
                $obj->status_code = 201;
                $obj->title       = "Success";
