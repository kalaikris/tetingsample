                            ...
                            <div class="input-form-group-item">
                                <div class="login-input-action-set" id="phone_mobileno">
                                    <div class="login-input-group phone">
                                        ...
                                        <input type="tel" class="login-input-box" id="mobile_no" name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-form-group-item">
                                <div class="login-input-action-set" id="mobile_alt_no">
                                    <div class="login-input-group phone">
                                        ...
                                        <input type="tel" class="login-input-box" id="alt_mobile_no" name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                    </div>
                                </div>
                            </div>
...
var distributor_id = <?php echo $_COOKIE['service_token']; ?>;
