                        ...
                        $service_val = 0;
                            foreach ($order_value->order_detail_array as $service_key => $service_value) {
                                if ($service_value->token == $this->order_detail_token && $service_value->can_be_cancelled){
                                    ...
                                    $grand_total = $service_collectamount + $conv_collectamount;
                                    ...
                                    $invoice_html .= '<td style="text-align:center;">
                                                        ...
                                                        <td style="text-align:center;">
                                                            <tr>
                                                                <td>
                                                                    <span style="font-size: 12px;">' . number_format(($grand_total  * 100)/118, 2, '.', '') . '</span>
                                                                    <br><br>
                                                                </td>
                                                            </tr>
                                                        </td>';
                                    if($service_value->tax_type == 2){
                                        $invoice_html .= '<td style="text-align:center;">
                                                        ...
                                                        <td style="text-align:center;">
                                                            <tr>
                                                                <td>
                                                                    <span style="font-size: 12px;">' . number_format((($grand_total  * 100)/118)*0.09, 2, '.', '') . '</span>
                                                                    <br>
                                                                    <span style="font-size: 12px;">' . number_format((($grand_total  * 100)/118)*0.09, 2, '.', '') . '</span>
                                                                    <br>
                                                                </td>
                                        ...
                                        $invoice_html .= '<td style="text-align:center;">
                                                        ...
                                                        <td style="text-align:center;">
                                                            <tr>
                                                                <td>
                                                                    <span style="font-size: 12px;">' . number_format((($grand_total  * 100)/118)*0.18, 2, '.', '') . '</span>
                                                                    <br>
                                                                    <span style="font-size: 12px;"></span>
                                                                    <br>
                                                                </td>
