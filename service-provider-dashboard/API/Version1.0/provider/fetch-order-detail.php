...
include '../../../../whitelabelling-webapp/php/objects/users-booking.php';
$users_booking = new UsersBooking();

include '../../../../whitelabelling-webapp/php/objects/users-booking-detail.php';
$users_booking_detail = new UsersBookingDetail();

include '../../../../whitelabelling-webapp/php/objects/users-booking-passenger.php';
$users_booking_passenger = new UsersBookingPassenger();

include '../../../../whitelabelling-webapp/php/objects/users-booking-journey.php';
$users_booking_journey = new UsersBookingJourney();

include '../../../../whitelabelling-webapp/php/objects/airport.php'; 
$airport = new Airport();
...
function fetchOrderDetail() {
    ...
    if ($users_booking->stmt->rowCount() > 0) {
        ...
        $service_distributor_token = $users_booking_value->service_distributor_token;
        $order_detail = [];
        $passenger_detail = [];
        $journey_detail = [];
        ...
        $agent_boolean = intval($users_booking_value->agent_boolean);
        ...
        foreach ($order_detail as $order_value) {
            ...
            foreach ($order_value->order_detail_array as $service_detail) {
                $cancel_detail->airportzo_cancellation_fee = $airportzo_cancellation_fee;
                $cancel_detail->service_detail = $service_detail;
                if ($service_detail->status != 'Cancelled') {
                    $cancel_detail->sp_rejection = $users_booking->sp_rejection;
                    $cancel_detail->is_agent_user = $agent_boolean;
        ...
        $users_booking_value->distributor_token = $service_distributor_token;
