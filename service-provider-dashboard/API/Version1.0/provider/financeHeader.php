...
$finance = new Finance();
$finance->serviceProviderLocationtoken= $inputData->serviceProviderLocationtoken;
...
$obj->realizedRevenue     = $finance->revenue();
...
$obj->unRealizedRevenue   = $finance->revenue();
...
$obj->thisMonthEarning    = $finance->revenue();
...
$obj->lastMonthEarning    = $finance->revenue();
...
$obj->lastSixMonthEarning = $finance->revenue();

//$newdate = date("Y-m-d 00:00:00", strtotime( "-12 months", strtotime ($gm_date_time) ));
$year = date("Y");
$previousyear = $year -1;
...
$obj->lastYearEarning     = $finance->revenue();

$creditDetails            = $finance->providerCreditView();
