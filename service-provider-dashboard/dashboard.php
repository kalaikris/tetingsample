...
<html lang="en">
    ...
    <body id="page">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                                    ...
                                    <div class="month-booking-pop">
                                        ...
                                        <div class="prograss-set">
                                            <div class="prograss-bar">
                                                <div class="prograss-inner5" id="five_star_prograssbar_full"></div>
                                            </div>
                                            <div class="prograss-bar">
                                                <div class="prograss-inner4" id="four_star_prograssbar_full"></div>
                                            </div>
                                            <div class="prograss-bar">
                                                <div class="prograss-inner3" id="three_star_prograssbar_full"></div>
                                            </div>
                                            <div class="prograss-bar">
                                                <div class="prograss-inner2" id="two_star_prograssbar_full"></div>
                                            </div>
                                            <div class="prograss-bar">
                                                <div class="prograss-inner1" id="single_star_prograssbar_full"></div>
                                            </div>
                                        </div>
                                        <ul class="month-booking-set">
                            ...
                            <button type="button" class="close size" data-dismiss="modal" aria-label="Close" id="full_recent_review">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="box">
                                <select class="header select__rating-list" id="reviewratings">
        ...
        <script>
            ...
            $('body').on('click','#full_recent_review',function(){
                data_fetch("");
            });
