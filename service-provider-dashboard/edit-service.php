...
<html>
   ...
   // Create location
    ...
    function upload_documents(idNo){
        var pass=5;
//        if(document.getElementById("gstfile_url"+idNo).value.trim() == ""){
...
//            pass++;
//        }if(document.getElementById("msmefile_url"+idNo).value.trim() == ""){
...
//            pass++;
//        }if(document.getElementById("incorporationfile_url"+idNo).value.trim() == ""){
...
//            pass++;
//        }if(document.getElementById("chequefile_url"+idNo).value.trim() == ""){
...
//            pass++;
//        }if(document.getElementById("agreementfile_url"+idNo).value.trim() == ""){
...
//        }
                                ...
                                newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            <div class="pan_cont pan_cont1`+doc+`">
                                                ...
                                                <input id="gstImage`+doc+`" type="file" onchange="imageUpload('gstImage`+doc+`','gstValidId`+doc+`','gstfile_url`+doc+`','uploadedtext`+doc+`','pan_cont1`+doc+`','gstImageErr`+doc+`');" accept="image/x-png, image/gif, image/jpeg,image/jpg,application/pdf" style="display:none;">
                                            </div>
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 108px;" onclick="clear_modalValue('gstImage`+doc+`','uploadedtext`+doc+`','pan_cont1`+doc+`','gstImageErr`+doc+`','gstfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>`;
                                    ...
                                    newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            <div class="pan_cont pan_cont2`+doc+`">
                                                ...
                                                <input id="msmeImage`+doc+`" type="file" onchange="imageUpload('msmeImage`+doc+`','msmeValidId`+doc+`','msmefile_url`+doc+`','uploadedtext1`+doc+`','pan_cont2`+doc+`','msmeImageErr`+doc+`');" accept="image/x-png, image/gif, image/jpeg,image/jpg,application/pdf" style="display:none;">
                                            </div>
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 169px;" onclick="clear_modalValue('msmeImage`+doc+`','uploadedtext1`+doc+`','pan_cont2`+doc+`','msmeImageErr`+doc+`','msmefile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            <div class="pan_cont pan_cont3`+doc+`">
                                                ...
                                                <input id="incorporationImage`+doc+`" type="file" onchange="imageUpload('incorporationImage`+doc+`','incorporationValidId`+doc+`','incorporationfile_url`+doc+`','uploadedtext2`+doc+`','pan_cont3`+doc+`','incorporationImageErr`+doc+`');" accept="image/x-png, image/gif, image/jpeg,image/jpg,application/pdf" style="display:none;">
                                            </div>
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 248px;" onclick="clear_modalValue('incorporationImage`+doc+`','uploadedtext2`+doc+`','pan_cont3`+doc+`','incorporationImageErr`+doc+`','incorporationfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>`;
                        ...
                        newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            <div class="pan_cont pan_cont4`+doc+`">
                                                ...
                                                <input id="chequeImage`+doc+`" type="file" onchange="imageUpload('chequeImage`+doc+`','chequeValidId`+doc+`','chequefile_url`+doc+`','uploadedtext3`+doc+`','pan_cont4`+doc+`','chequeImageErr`+doc+`');" accept="image/x-png, image/gif, image/jpeg,image/jpg,application/pdf" style="display:none;">
                                            </div>
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 326px;" onclick="clear_modalValue('chequeImage`+doc+`','uploadedtext3`+doc+`','pan_cont4`+doc+`','chequeImageErr`+doc+`','chequefile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            <div class="pan_cont pan_cont5`+doc+`">
                                                ...
                                                <input id="agreementImage`+doc+`" type="file" onchange="imageUpload('agreementImage`+doc+`','agreementValidId`+doc+`','agreementfile_url`+doc+`','uploadedtext4`+doc+`','pan_cont5`+doc+`','agreementImageErr`+doc+`');" accept="image/x-png, image/gif, image/jpeg,image/jpg,application/pdf" style="display:none;">
                                            </div>
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 403px;" onclick="clear_modalValue('agreementImage`+doc+`','uploadedtext4`+doc+`','pan_cont5`+doc+`','agreementImageErr`+doc+`','agreementfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    function removedoc(doc){
        $(`#upload_document${doc}`).modal({backdrop: 'static', keyboard: false},'hide');
        // $(`#upload_document${doc}`).remove();
    }
    ...
    function nextButton(){
        ...
        new_location_array.forEach((i,index) =>{
            ...
            if($('#uploadedtext5'+i).attr('data-uploaded5'+i) == "true" && $('#uploadedtext6'+i).attr('data-uploaded6'+i) == "true" && $("#AirportName"+i).val() != '' && email11234.match(mailformat12345)){
                if(count==index){
                    validForReview = true;
...
//                        gst_certificate:$('#gstfile_url'+i).val(),
//                        msme_certificate:$('#msmefile_url'+i).val(),
//                        certificate_incorporation:$('#incorporationfile_url'+i).val(),
//                        void_cheque:$('#chequefile_url'+i).val(),
//                        certificate_agreement:$('#agreementfile_url'+i).val(),
                                ...
                                if(location_array[key].gst_certificate != ''){
                                    getText += `<div class="document-items">`;
                                            ...
                                            if(gstextension == 'pdf'){
                                                ...
                                                getText+=`<p class="file-name">GST Certificate</p>
                                    </div>`;
                                }
    ...
    function go_to_dashboard(){
        ...
        function appendfirstcompanyDetails(token){
            ...
            $.ajax({
                ...
                console.log(firstCompanyDetailsObject);
               ...
               $('#businessName').val(firstCompanyDetailsObject.companyName);
                ...
                firstCompanyDetailsObject.serviceLocations.forEach((locationdetails,index) => {
                    ...
                    if(index == 0){
                        $(`#AirportName${new_location_count}`).val(locationdetails.airportToken);
                        console.log('====================================');
                        console.log(locationdetails.airportToken);
                        console.log('====================================');
                        $(`#AirportName${new_location_count}`).trigger("chosen:updated");
                        $(`#location_email_address${new_location_count}`).val(locationdetails.emailId);
                        multipleDocument(new_location_count);
                        multipleBankDetail(new_location_count);
                        $(`#account_number${new_location_count}`).val(locationdetails.accountNumber);
                        $(`#reenter_account_number${new_location_count}`).val(locationdetails.accountNumber);
                        $('#container'+new_location_count+' > input').val(locationdetails.ifscCode);
                        getDetailsClick(new_location_count);

                        $(`#gst_number${new_location_count}`).val(locationdetails.gst_number);
                        $(`#pan_number${new_location_count}`).val(locationdetails.pancard_number);
                        //Pan/Tax upload
                        if(locationdetails.pan_certificate != ''){
                            $(`#panfile_url${new_location_count}`).val(locationdetails.pan_certificate);
                            $(`.uploadedtext${new_location_count}`).css("display", "block");
                            $(`.pan_cont1${new_location_count}`).hide();
                            $(`#gstImageErr${new_location_count}`).text(""); 
                        }
                        
                        //gst upload
                        if(locationdetails.gstCertificate != ''){
                            $(`#gstfile_url${new_location_count}`).val(locationdetails.gstCertificate);
                            $(`.uploadedtext${new_location_count}`).css("display", "block");
                            $(`.pan_cont1${new_location_count}`).hide();
                            $(`#gstImageErr${new_location_count}`).text("");
                        }
                        ...
                        if(locationdetails.msmeCertificate != ''){
                            $(`#msmefile_url${new_location_count}`).val(locationdetails.msmeCertificate);
                            $(`.uploadedtext1${new_location_count}`).css("display", "block");
                            $(`.pan_cont2${new_location_count}`).hide();
                            $(`#msmeImageErr${new_location_count}`).text("");
                        }
                        
                        //incorporationfile upload
                        if(locationdetails.incorporationCertificate != ''){
                            $(`#incorporationfile_url${new_location_count}`).val(locationdetails.incorporationCertificate);
                            $(`.uploadedtext2${new_location_count}`).css("display", "block");
                            $(`.pan_cont3${new_location_count}`).hide();
                            $(`#incorporationImageErr${new_location_count}`).text("");
                        }
                        
                        //chequefile upload
                        if(locationdetails.voideCheck != ''){
                            $(`#chequefile_url${new_location_count}`).val(locationdetails.voideCheck);
                            $(`.uploadedtext3${new_location_count}`).css("display", "block");
                            $(`.pan_cont4${new_location_count}`).hide();
                            $(`#chequeImageErr${new_location_count}`).text("");
                        }
                        
                        //agreementfile upload
                        if(locationdetails.agreement != ''){
                            $(`#agreementfile_url${new_location_count}`).val(locationdetails.agreement);
                            $(`.uploadedtext4${new_location_count}`).css("display", "block");
                            $(`.pan_cont5${new_location_count}`).hide();
                            $(`#agreementImageErr${new_location_count}`).text("");
                        }
                        
                        //Other doc1 upload
                        if(locationdetails.other_document_one != ''){
                            $(`#otherDocument1file_url${new_location_count}`).val(locationdetails.other_document_one);
                            $(`.uploadedtext8${new_location_count}`).css("display", "block");
                            $(`.pan_cont7${new_location_count}`).hide();
                            $(`#otherDocument1ImageErr${new_location_count}`).text("");
                        }
                        
                        //other doc2 upload
                        if(locationdetails.other_document_two != ''){
                            $(`#otherDocument2file_url${new_location_count}`).val(locationdetails.other_document_two);
                            $(`.uploadedtext9${new_location_count}`).css("display", "block");
                            $(`.pan_cont8${new_location_count}`).hide();
                            $(`#otherDocument1ImageErr${new_location_count}`).text("");
                        }
                        
                        //Add Completed status for image upload
                        $('#upload_document'+new_location_count).modal('hide');
                        $('#uploadedtext5'+new_location_count).show();
                        $('#uploadedtext5'+new_location_count).attr('data-uploaded5'+new_location_count+'', 'true');
                        $('#divhiding5'+new_location_count).hide();
                        $('#add_document_label_name'+new_location_count).show();

                        //Add Completed status for bank details upload
                        $('#uploadedtext6'+new_location_count).show();
                        $('#uploadedtext6'+new_location_count).attr('data-uploaded6'+new_location_count+'', 'true');
                        $('#divhiding6'+new_location_count).hide();
                        $('#add_bank_label_name'+new_location_count).show();
                        
                        firstCompanyDetailsObject.serviceLocations.forEach((locationdetailss,index) => {
                            if(index != 0){
                               $(`#AirportName${new_location_count} option[value='${locationdetailss.airportToken}']`).prop('disabled', true).trigger("chosen:updated");
                            }
                        });
                        ...
                        //setting values for locations more than one
                        $(`#AirportName${new_location_count}`).val(locationdetails.airportToken);
                        $(`#AirportName${new_location_count}`).trigger("chosen:updated");
                        $(`#location_email_address${new_location_count}`).val(locationdetails.emailId);
                        multipleDocument(new_location_count); //adding div for doc upload
                        multipleBankDetail(new_location_count); //adding div for bank detail upload
                        $(`#account_number${new_location_count}`).val(locationdetails.accountNumber);
                        $(`#reenter_account_number${new_location_count}`).val(locationdetails.accountNumber);
                        $('#container'+new_location_count+' > input').val(locationdetails.ifscCode);
                        getDetailsClick(new_location_count);
...
//                        //msme upload
//                        $(`#msmefile_url${new_location_count}`).val(locationdetails.gstCertificate);
//                        $(`.uploadedtext1${new_location_count}`).css("display", "block");
//                        $(`.pan_cont2${new_location_count}`).hide();
//                        $(`#msmeImageErr${new_location_count}`).text("");

//                        //incorporationfile upload
//                        $(`#incorporationfile_url${new_location_count}`).val(locationdetails.gstCertificate);
//                        $(`.uploadedtext2${new_location_count}`).css("display", "block");
//                        $(`.pan_cont3${new_location_count}`).hide();
//                        $(`#incorporationImageErr${new_location_count}`).text("");
