...
<html>
                        ...
                        <div class="input-form-group">
                            ...
                            <div class="text-box-group">
                                <div class="input-form-group-item">
                                    <div class="input-box-set">
                                        <p>Pincode</p>
                                        <input type="email" class="input-box" id="pincodedata" placeholder="Enter Pincode">
                                    </div>
                                </div>
                                <div>
    ...
    <script src="js/testing.js?v=<?php echo $cur_date_time; ?>"></script>
    <script>
    var airportdata='';
    var apiPath = "<?php echo $apiPath; ?>";
    console.log('<?php echo $s3_poolid ?>');
   ...
   // Create location
    ...
    $('#add_new_location').on('click',function(){
        Locationcount+=1;
        Locationarray.push(Locationcount);
        var newLOcation = Locationcount;
        let location_design = '';
        location_design = `
                    <div class="ser-location-set" id="new_service_location`+newLOcation+`">
                        <div class="step-form-header">
                            <h3>Location `+newLOcation+`</h3>
                            <p>Choose the terminal where you provide the service and upload its necessary documents</p>
                        </div>
                        <div class="input-form-group">
                            <div class="input-form-group-items">
                                <div class="input-box-set">
                                    <p>Airport</p>
                                    <select class="select-input" id="AirportName`+newLOcation+`"></select>
                                </div>
                            </div>
                            <p id="AirportNameErr`+newLOcation+`" style="color: red; font-size: 13px;"></p>
                        </div>
                        <div class="text-box-group">
                            <div class="input-form-group-item">
                                <div class="input-box-set">
                                    <p>Email Address</p>
                                    <input type="email" class="input-box" id="location_email_address`+newLOcation+`" placeholder="Enter Email Address" autocomplete="off">
                                </div>
                            </div>
                            <div>
                                <p id="location_email_addressErr`+newLOcation+`" style="color: red; font-size: 13px;"></p>
                            </div>
                        </div>
                        <div class="upload-set">
                            <div class="upload-items" id="divhiding5`+newLOcation+`" >
                                <label for="" class="upload-label" data-toggle="modal" onclick="multipleDocument(`+newLOcation+`)" data-target="#upload_document`+newLOcation+`">
                                    <input type="file" class="input-file" id="document_upload">
                                    <p><img src="asset/images/upload-sm-icon.svg" alt="upload icon" class="btn-icon"> Upload documents</p>
                                </label>
                            </div>
                            <div class="">
                                <p id="add_document_label_name`+newLOcation+`" style="display: none;">Upload Documents</p>
                                <div class="succes-icon-text" id="uploadedtext5`+newLOcation+`" style="display: none;">
                                    <img src="asset/images/tick-icon.png" class="tick-icon">
                                    <p>Completed</p>
                                    <img src="asset/edit.png" onclick="Edit_document('upload_document`+newLOcation+`')">
                                </div>
                            </div>
                            <div class="upload-items" id="divhiding6`+newLOcation+`" >
                                <label for="" class="upload-label" data-toggle="modal" onclick="multipleBankDetail(`+newLOcation+`)" data-target="#upload_bank_account_document`+newLOcation+`">
                                    <input type="file" class="input-file" id="bank_account_document">
                                    <p><img src="asset/images/bank-sm-icon.svg" alt="upload icon" class="btn-icon"> Add Bank Account</p>
                                </label>
                            </div>
                            <div class="">
                                <p id="add_bank_label_name`+newLOcation+`" style="display: none;">Add Bank Account</p>
                                <div class="succes-icon-text" id="uploadedtext6`+newLOcation+`" style="display: none;">
                                    <img src="asset/images/tick-icon.png" class="tick-icon">
                                    <p>Completed</p>
                                    <img src="asset/edit.png" onclick="Edit_bankaccount('upload_bank_account_document`+newLOcation+`')">
                                </div>
                            </div>
                        </div>`;
                            location_design+=`  <div class="upload-items" id="remove_add_location">
                                                    <label class="upload-label" id="remove_location">
                                                        <p onclick="removePreviousLocation('new_service_location`+newLOcation+`',`+newLOcation+`)">Remove location</p>
                                                    </label>
                                                </div>`;
                        location_design+=`<div class="underline-div"></div>
                    </div>`;
        $('#ser_input_group').append(location_design);
        newAirportDropDown(newLOcation);
    });
    ...
    function removePreviousLocation(id,key){
        $('#'+id).remove();
        let idx1 = Locationarray.indexOf(key);   //Remove the token to the array
        if (idx1 != -1) Locationarray.splice(idx1, 1);
    }
                                    ...
                                    <div class="pan_uploaded_cont">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 108px;" onclick="clear_modalValue('gstImage`+doc+`','uploadedtext`+doc+`','pan_cont1`+doc+`','gstImageErr`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 169px;" onclick="clear_modalValue('msmeImage`+doc+`','uploadedtext1`+doc+`','pan_cont2`+doc+`','msmeImageErr`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 248px;" onclick="clear_modalValue('incorporationImage`+doc+`','uploadedtext2`+doc+`','pan_cont3`+doc+`','incorporationImageErr`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 326px;" onclick="clear_modalValue('chequeImage`+doc+`','uploadedtext3`+doc+`','pan_cont4`+doc+`','chequeImageErr`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="close-icon" style="margin-top: 403px;" onclick="clear_modalValue('agreementImage`+doc+`','uploadedtext4`+doc+`','pan_cont5`+doc+`','agreementImageErr`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
