                                ...
                                newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="" style="margin-left: 10px;width:15px;" onclick="clear_modalValue('gstImage`+doc+`','uploadedtext`+doc+`','pan_cont1`+doc+`','gstImageErr`+doc+`','gstfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>`;
                                    ...
                                    newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="" style="margin-left: 10px;width:15px;" onclick="clear_modalValue('msmeImage`+doc+`','uploadedtext1`+doc+`','pan_cont2`+doc+`','msmeImageErr`+doc+`','msmefile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="" style="margin-left: 10px;width:15px;" onclick="clear_modalValue('incorporationImage`+doc+`','uploadedtext2`+doc+`','pan_cont3`+doc+`','incorporationImageErr`+doc+`','incorporationfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>`;
                        ...
                        newDocument += `<div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="" style="margin-left: 10px;width:15px;" onclick="clear_modalValue('chequeImage`+doc+`','uploadedtext3`+doc+`','pan_cont4`+doc+`','chequeImageErr`+doc+`','chequefile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="Upload_data_box">
                                        ...
                                        <div class="texte-btton">
                                            ...
                                            <div class="succes-icon-text">
                                                <img src="asset/images/tick-icon.png" class="tick-icon">
                                                <p>Uploaded</p>
                                                <img src="asset/images/close.svg" alt="close icon" class="" style="margin-left: 10px;width:15px;" onclick="clear_modalValue('agreementImage`+doc+`','uploadedtext4`+doc+`','pan_cont5`+doc+`','agreementImageErr`+doc+`','agreementfile_url`+doc+`')">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
