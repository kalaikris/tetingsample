...
?>
    ...
    <body id="page">
                    ...
                    <div class="comen-set-box hidden">
                        ...
                        <section class="step-content-items busines-info" id="busines_info">
                            <div class="sub-form-header">
                                <h3>Location</h3>
                                <p>Tell us where your service is located</p>
                            </div>
                            ...
                            <div class="sub-form-header">
                                <h3>Let people know more about your service</h3>
                                <p>Give a brief about your services</p>
                            </div>
                            <div class="input-form-group">
                            ...
                            <div class="form-divider"></div>
                            <div class="sub-form-header">
                                <h3>Let's add your service photos</h3>
                                <p>Give a brief about your services</p>
                            </div>
                            ...
                            <div class="sub-form-header">
                                <h3>Add amenities</h3>
                                <p>Choose the amenities which your service provides</p>
                            </div>
                            ...
                            <div class="sub-form-header">
                                ...
                                <p>Set the operating Hours of your Service. only during these times you will receive bookings</p>
                            </div>
                        ...
                        <div class="tabs">
                            ...
                            <div id="tab1" class="tab-content">
                                ...
                                <div class="main-brief">
                                    <div class="buss-shop">
                                        <h3 class="business-pranaa">Brief about shop</h3>
                            ...
                            <div id="tab2" class="tab-content">
                                <div class="serivce-detail-container">
                                    <ul id="tabs-nav2" class="box-tabs">
                                        <li><a href="#bundle-service-list-view">Business Services</a></li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body-set">
                        ...
                        <div class="popup-btn-set">
                            <button class="cust-btn cust-btn-xl cust-btn-success" onclick="termsandcondition()">Terms And Condition</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body-set">
                        ...
                        <div class="popup-btn-set">
                            <button class="cust-btn cust-btn-xl cust-btn-success" onclick="privacypolicy()">Privacy Policies</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body-set">
                        ...
                        <div class="popup-btn-set">
                            <button class="cust-btn cust-btn-xl cust-btn-success" onclick="cancelpolicy()">Cancellation Charges</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body-set">
                        ...
                        <div class="popup-btn-set">
                            <button class="cust-btn cust-btn-xl cust-btn-success" onclick="reschedule_policy()">Reschedule Policies</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
                            ...
                            service_bundled_list +=`<div class="service-package-box">
                                                    ...
                                                    for(var bundlelocation in servicelocation){
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="view-more" data-toggle="modal" data-target="#view_service-package" onclick="view_full_bundled_package('${service_bundled[bundlekey].serviceName}','${servicelocation[bundlelocation].category}','${servicelocation[bundlelocation].airportType}','${servicelocation[bundlelocation].priceAdult}','${servicelocation[bundlelocation].priceChild}','${featuresbundled}')">View more</p>
                                                        </div>
                                                        </li>`;
                                                    }
                            ...
                            serviceindividual +=`<div class="service-package-box">
                                                    ...
                                                    for(var individuallocation in servicelocation){
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="view-more" data-toggle="modal" data-target="#view_individual_service_package" onclick="view_full_individual_package('${service__individualpackage[individualkey].serviceName}','${servicelocation[individuallocation].category}','${servicelocation[individuallocation].airportType}','${servicelocation[individuallocation].priceAdult}','${servicelocation[individuallocation].priceChild}','${featuresindividual}')">View more</p>
                                                        </div>
                                                        </li>`;
                                                    }
            ...
            function view_full_bundled_package(data1,data2,data3,data4,data5,data6){
                ...
                $('#bundled_feature').html(data6);
            }

            function edit_bundle_package(serviceProviderLocationtoken,serviceName,bundledcategory_token,bundledairporttype_token,adultRate,childRate,bundlekey,bundlelocationkey){
                var datas = {
            ...
            function update_bundled_service(){
                ...
                var bundled_feature_count = ((removefeature_array.length)+2);
            ...
            function view_full_individual_package(data1,data2,data3,data4,data5,data6){
                ...
                $('#individual_feature').html(data6);
            }

            function edit_individual_package(serviceProviderLocationtoken,individualserviceName,individualcategory_token,individualairporttype_token,adultRate,childRate,individualkey,individuallocationkey){
                var datas = {
                    'serviceProviderLocationtoken': serviceProviderLocationtoken
                };
                var JsonData = JSON.stringify(datas);
            ...
            function update_individual_service(){
                ...
                var individual_feature_count = ((individualremovefeature_array.length)+2);
                        ...
                        edit_service_cancellation += `<div id="edit_removeCharges`+keys1+`">
                            <div class="type-changing" id="clearslot`+keys1+`">
                                ...
                                <div>
                                    <div class="main-hours">
                                        <div class="timeing">
                                            <input style="" type="text" value="${edit_cancellationcharge[keys1].percentage}" id="edit_totalbookingamount`+keys1+`" maxlength="3" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="location-hours">
                                            <h5>% of total booking amount</h5>
                                        </div>`;
            ...
            function business_info() {
                ...
                if (document.getElementById("coordinates_input").value == "") {
                    ...
                    document.getElementById("shop_messageErr").innerHTML = "* Please Enter Your Shop Description !";
                }else{
                    document.getElementById("shop_messageErr").innerHTML = "";
                    pass++;
                }if (document.getElementById("shopimage1").value == "") {
                    document.getElementById("shopimage1Err").innerHTML = "* Please Upload Shop Image !";
                }else{
                    document.getElementById("shopimage1Err").innerHTML = "";
                    pass++;
                }if (document.getElementById("shopimage2").value == "") {
                    document.getElementById("shopimage2Err").innerHTML = "* Please Upload Shop Image !";
                }else{
                    document.getElementById("shopimage2Err").innerHTML = "";
                    pass++;
                }if (document.getElementById("shopimage3").value == "") {
                    document.getElementById("shopimage3Err").innerHTML = "* Add Your Shop Images !";
                }else{
            ...
            newCharge = `<div class="set_cancellation_charge" id="removeCharges` + addCharge + `">
                            <div class="type-changing" id="clearslot` + addCharge + `">
                                ...
                                <div>
                                    <div class="main-hours">
                                        <div class="timeing">
                                            <input style="border: 1px solid #a9a9a9;text-align: center;" type="text" id="totalbookingamount` + addCharge + `" maxlength="3" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="location-hours">
                                            <h5>% of total booking amount</h5>
                                        </div>`;
            ...
            edit_Charge = `<div id="edit_removeCharges` + edit_count + `">
                            <div class="type-changing" id="clearslot` + edit_count + `">
                                ...
                                <div>
                                    <div class="main-hours">
                                        <div class="timeing">
                                            <input style="" type="text" value="" id="edit_totalbookingamount` + edit_count + `" maxlength="3" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="location-hours">
                                            <h5>% of total booking amount</h5>
                                        </div>
            ...
            $('#tabs-nav2 li').click(function () {
             ...
             function edit_business_info() {
                ...
                if (document.getElementById("edit_coordinates_input").value == "") {
                    ...
                    document.getElementById("edit_shop_messageErr").innerHTML = "* Please Enter Your Shop Description !";
                }else{
