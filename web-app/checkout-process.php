...
<body onload="loadDistributorDetail();">
            ...
            <div class="container">
                ...
                <div class="main-form">
                    <div class="setup-content active" id="step-1">
                        ...
                        <div style="display:flex;justify-content: space-between;flex-wrap:wrap;row-gap: 12px">
                            <div class="">
                                <div class="step-form-header">
                        ...
                        <div id="generate_link">
                            <form action="">
                                <div class="input-form-group-item">
                                    <div class="select-group">
                                        <select class="select-box" id="passengerTitle">
                                    ...
                                    <div class="input-box-set border-right">
                                        ...
                                        <input type="text" class="input-box" id="passengerName"
                                            placeholder="Enter Name">
                                        <p id="passengerNameErr"></p>
                                    </div>
                                </div>
                                <div class="login-input-action-set">
                                    <div class="login-input-group phone">
                                        <p>Mobile Number<span>*</span></p>
                                        <input type="tel" class="login-input-box" id="passengerMobile" name="phone" />
                                        <p id="passengerMobileErr"></p>
                                    </div>
                                </div>
                                <div class="input-form-group-item">
                                    <div class="input-box-set">
                                        <p>Email Address<span>*</span></p>
                                        <input type="text" class="input-box" id="passengerEmail"
                                            placeholder="Enter Email Address">
                                        <p id="passengerEmailErr"></p>
                                    </div>
                                </div>
                                <div class="input-form-group-item">
                                    <div class="input-box-set">
                                        <p>Description<span>*</span></p>
                                        <textarea type="text" class="input-box" id="passengerDesc"
                                            placeholder="Enter Description"></textarea>
                                        <p id="passengerDescErr"></p>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="step-form-header">
                            ...
                            <div class="proceed-checkbtn" id="rzp-pre-payment">
                                <button class="proceed-btn proceed-to-pay" onclick="proceedToPay()">Proceed to
                                    Pay</button>
                                <button class="generate-link" onclick="validate_plink_info()">Generate Link</button>
                            </div>
                            <div class="proceed-checkbtn" style="display: none;" id="rzp-payment">
                                <button class="proceed-btn" id="rzp-button1">PAY NOW</button>
                            </div>
                        </div>
    ...
    <script for="Back-end">
        ...
        $(document).ready(function () {
            var backEndBookingToken = $("body").attr("data-usr-token");
            if (backEndBookingToken != "1212121212") {
                $('.proceed-to-pay').css('display', 'block');
                $('.generate-link').css('display', 'none');
                $('#generate_link').css('display', 'none');
            } else {
                $('#generate_link').css('display', 'block');
                $('.proceed-to-pay').css('display', 'none');
                    ...
                    success: function (response) {
                        if (response.status_code == 200) {
                            ...
                            responseData.forEach(function (passengerObj, passengerKey) {
                                ...
                                $('#passenger-history').append(makePassengerHistoryCard(passengerObj, (passengerHistory.length - 1)));
                            });
        ...
        function addPassenger() {
            ...
            var mobile_number = $('#passenger-mobile').val().trim();
            ...
            if (title != '' && name != '' && (!isMobileMandatory || mobile_number != '') && (!isEmailMandatory || (email_id != '' && isEmail)) && (!hasAgeCheck || isAdult)) { //(date_of_birth!='' || passenger_type == 'greet')
                ...
                if (index > 0) {
                    ...
                    addPassengerCard(passengerData);
                    // } else {
                    //     let ageQualified = false;
                    //     if ( passengerData.age.includes('yrs') ) {
                    //         var age = parseInt(passengerData.age.replace(' yrs', ''));
                    //         if (age >= 12) {
                    //             ageQualified = true;
                    //         }
                    //     }
                    ...
                    //     } else {
                    //         swal({
                    //             text: "Lead person should atleast be 12 years old !",
                    //             icon: "warning",
                    //         });
                    //     }
                    // }
                    ...
                    //     ageQualified = true;
                    // } else {
                    //     var passengerAge = dateDiff(date_of_birth);
                    //     if ( passengerAge.includes('yrs') ) {
                    //         var age = parseInt(passengerAge.replace(' yrs', ''));
                    //         if (age >= 12) {
                    //             ageQualified = true;
                    //         }
                    //     }
                            ...
                            if (response.status_code == 200) {
                                ...
                                swal("", response.message, "success")
                                    .then(function () {
                                        ...
                                        $('#passenger-history').append(makePassengerHistoryCard(passengerData, passengerHistory.length));
            ...
            $('.passenger-remover').on('click', function () {
                ...
                switch ($(this).attr('data-type')) {
                    ...
                    case 'greet':
                        ...
                        $('#add-greet-passenger').text('Add Alternate contact');
        ...
        function proceedToPay() {
            ...
            if (document.getElementById('checkout-agreement').checked) {
                if (contactPassenger.hasOwnProperty('mobile_number') && eTicket != '') {
                    ...
                    var journeyArray = JSON.parse(sessionStorage.getItem("jsonJourney"));
                    var journeyDate = journeyArray[0].departure_date;
                    ...
                    if(totalPassengerCount == totalPassengersAdded){
                        ...
                        var orderInput = { 'station_array': stationArray, "currency": currencySelected, "coupon_code": coupon__code, "coupon_status": coupon_status, "coupon_type": coupon__type };
                        ...
                        $.ajax({
                            ...
                            success: function (orderResponse) {
                                if (orderResponse.status_code == 200) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (bookingResponse) {
                                                    if (bookingResponse.status_code == 200) {
                                                        ...
                                                        swal("", bookingResponse.message, "error");
                                                    }
                                    ...
                                    $('#rzp-pre-payment').css("display", "none");
                                    $('#rzp-payment').css("display", "block");
                                    setTimeout(function () { $('#loading').fadeOut(); }, 500);
    ...
    <script>
        function validate_plink_info() {
            var pass = 0;
            if (document.getElementById("passengerName").value.trim() == "") {
                document.getElementById("passengerNameErr").innerHTML = "* Please Enter Your Name!";
            } else {
                document.getElementById("passengerNameErr").innerHTML = "";
                pass++;
            }
            if (document.getElementById("passengerMobile").value.trim() != '') {
                if (iti.isValidNumber()) {
                    document.getElementById("passengerMobileErr").innerHTML = "";
                    pass++;
                } else {
                    var errorMap = ["Invalid number", "Invalid country code", "Too short", "Too long", "Invalid number"];
                    var errorCode = iti.getValidationError();
                    document.getElementById("passengerMobileErr").innerHTML = errorMap[errorCode];
                }
            } else {
                document.getElementById("passengerMobileErr").innerHTML = "* Please Enter Mobile Number!";
            }
            var emailValid = document.getElementById("passengerEmail").value;
            mailformat = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            if (emailValid == '') {
                document.getElementById("passengerEmailErr").innerHTML = "* Please Enter Email Address !";
            } else if (emailValid.match(mailformat)) {
                document.getElementById("passengerEmailErr").innerHTML = "";
                pass++;
            } else {
                document.getElementById("passengerEmailErr").innerHTML = "* Enter Valid Mail-ID";
            }
            if (document.getElementById("passengerDesc").value.trim() == "") {
                document.getElementById("passengerDescErr").innerHTML = "* Please Enter Your Description!";
            } else {
                document.getElementById("passengerDescErr").innerHTML = "";
                pass++;
            }
            if (pass == 4) {
                generateLink();
            ...
            if (document.getElementById('checkout-agreement').checked) {
                if (contactPassenger.hasOwnProperty('mobile_number') && eTicket != '') {
                    ...
                    if(totalPassengerCount == totalPassengersAdded){
                        ...
                        // sessionStorage.setItem("currencySelected", "INR");
                        var currencySelected = (sessionStorage.getItem("currencySelected") === null) ? "INR" : sessionStorage.getItem("currencySelected");
                        var contactTitle = $('#passengerTitle').val();
                        if (contactTitle == "NULL") {
                            titleView = "Mr";
                        } else {
                            titleView = $('#passengerTitle').val();
                        }
                        var contactName = $('#passengerName').val();
                        contactName = titleView + '.' + contactName;
                        var countryCode = $("#passengerMobile").siblings(".iti__flag-container").find(".iti__selected-flag").attr("title");
                        countryCode = '+' + countryCode.replace(/[^0-9]/g, '');
                        var passengerMobile = $('#passengerMobile').val();
                        var contactNumber = countryCode + passengerMobile;
                        var contactEmail = $('#passengerEmail').val();
                        var contactDesc = $('#passengerDesc').val();
                        var orderInput = { 'station_array': stationArray, "currency": currencySelected, "contactName": contactName, "contactNumber": contactNumber, "contactEmail": contactEmail, "contactDesc": contactDesc, "coupon_code": coupon__code, "coupon_status": coupon_status, "coupon_type": coupon__type };
                        orderInput = JSON.stringify(orderInput);
                        $.ajax({
                            async: false,
                            type: 'POST',
                            url: 'php/razor/generate-link.php',
                            data: orderInput,
                            dataType: 'JSON',
                            success: function (orderResponse) {
                                if (orderResponse.status_code == 200) {
                                    var plink_id = orderResponse.plink_id;
                                    var total_amount = orderResponse.total_amount;
                                    var receipt = orderResponse.receipt;
                                    ...
                                    inputData.station_array = stationArray;
                                    inputData.journey_array = journeyArray;
                                    inputData.razorpay_plink_id = plink_id;
                                    inputData.razorpay_payment_id = "";
                                    inputData.razorpay_order_id = "";
                                    inputData.razorpay_signature = "";
                                    inputData.currency = currencySelected;
                                    inputData.paymentlink_name = contactName;
                                    inputData.paymentlink_mobile = contactNumber;
                                    inputData.paymentlink_email = contactEmail;
                                    inputData.paymentlink_description = contactDesc;
                                    inputData.coupon_code = coupon__code;
                                    inputData.coupon_status = coupon_status;
                                    inputData.coupon_type = coupon__type;
                                    ...
                                    $.ajax({
                                        async: false,
                                        type: 'POST',
                                        url: 'php/back-end-booking/createnew.php',
                                        data: inputJSONData,
                                        dataType: 'JSON',
                                        success: function (bookingResponse) {
                                            if (bookingResponse.status_code == 200) {
