...
<body onload="loadDistributorDetail();">
    <div class="main">
        ...
        <section class="cart-sec">
            <div class="container">
                <a href="choose-service.php" class="back-arrow"><img src="asset/choose-service/back-arrow.png"
                        class="back-arrow-icon" alt="back arrow"> back</a>
                    ...
                    <div class="bookhisty-right">
                        <div class="bookhisty-inner-set">
                            ...
                            <ul class="currency__drop-list1 hidden" id="">
                                <li class="currency__drop-item" onclick="changeCurrency('INR', 'INR')">INR</li>
                                <li class="currency__drop-item" onclick="changeCurrency('USD', 'USD')">USD</li>
                            </ul>
                            </p>
                            ...
                            <div class="point-redeem-set redeem-coupon">
                                ...
                                <div style="margin:auto;width:90%;">
                                    <div class="input-form-group-item">
                                        <div class="input-box-set">
                                            ...
                                            <input type="text" class="input-box" id="coupon_code" placeholder="AA1220099">
                                        </div>
                                    </div>

                                    <div class="flex fl-align-center" style="justify-content:space-between;">
                                        <p class="btn-text" data-target="#coupon_modal" data-toggle="modal">View all coupon</p>
                        ...
                        <!-- <div class="check_other-currencies">
                            ...
                            <button class="coupon_btn" style="cursor: pointer;">Check Coupon</button>
                        </div> -->

                        <div class="check_other-currencies hidden">
                        ...
                        <div class="currency__container">
                            <div class="currency__dropdown-box">
                                ...
                                <ul class="currency__drop-list hidden" id="currency">
                                    <li class="currency__drop-item" onclick="changeCurrency('INR', 'INR')">INR</li>
                                    <li class="currency__drop-item" onclick="changeCurrency('USD', 'USD')">USD</li>
                                    <li class="currency__drop-item" onclick="changeCurrency('AED', 'AED')">AED</li>
                                </ul>
                            </div>
        ...
        <!-- Add notes Modal -->
        <div id="coupon_modal" class="modal fade add-note-popup" role="dialog">
    ...
    <script for="Back-end">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status_code == 200) {
                        response.data.forEach(function (availCouponData) {
                            $('#available-coupon').append(`<li class="coupon__box">
                                <div class="coupon__content">
                                    ...
                                    <div class="coupon__code-box">
                                        ...
                                        <img src="asset/copy.svg" alt="copy icon">
                                    </div>
                            </li>`);
                        });
                    } else {
        ...
        couponButton.addEventListener('click', function () {
            ...
            if (couponCode != '') {
                var inputJSONData = JSON.stringify({ 'couponCode': couponCode, 'serviceToken': new_array });
