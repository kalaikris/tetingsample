...
<body onload="loadDistributorDetail();">
    ...
    <script>
        ...
        // //var currentHours = (current.getUTCHours() == 24)? current.getUTCHours(): (current.getUTCHours() + 1);
        ...
        function populateData() {
            ...
            globalStationData.forEach(function(stationData, stationKey) {
                ...
                if (stationData.hasOwnProperty('journey_time')) {
                    ...
                    gmtHours =  stationData.gmt_view.substr(4,3);
                    gmtMinutes =  stationData.gmt_view.substr(8,2);
                    ...
                    stationData.journey_time = newTravelTime; // add GMT time to local time
                }
        ...
        function addServicesToCart() {
            ...
            if (serviceDate && serviceDate != '' && serviceTime && serviceTime != '') {
                ...
                gmtHours =  globalStationData[selectedDataIndex].gmt_view.substr(4,3);
                gmtMinutes =  globalStationData[selectedDataIndex].gmt_view.substr(8,2);
                minConvert = gmtMinutes/60;
               if(minConvert == '00'){
                    getMinConvert = '.0';
                }else{
                ...
                if (Math.floor(timeDiff) >= 24 ||  (backendBooking == true && parsedServiceTime.getTime()-parsedCurrentTime.getTime() > 0)) {
