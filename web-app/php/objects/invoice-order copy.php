        ...
        $invoice_html = '<table style="width:100%" cellspacing="0" cellpadding="0">
                    ...
                    $invoice_html .= '</span>
                            ...
                            <th style="width:32%">
                                <div>
                                    <span style="">
                                        <span style="font-size: 17px;">Sold by:</span>
                                        <br>
                                        <span style="">
                    ...
                    $invoice_html .= '<br>
                                        <span style="">
                                            <span style="font-size:13px;">PAN NO : ' . $pan_no . ',</span>
                                        </span>
                                        <br>
                                        <span style="">
                                            <span style="font-size:13px;">GST Registration No : '.$gst_nos.'</span>
                                        </span>
                                        <br>
                                        <span style="">
                                            <span style="font-size:13px;">UT code : '.$ut_codes.'</span>
                                        </span>
                                    </span>
                                </div>
                            </th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="width:40%;text-align:right;line-height:25px;">
                                                                <span style="font-size: 12px;">₹ ' . ((int)$this->invoice_obj->service_amount +  (int)$this->invoice_obj->service_gst). '</span>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
