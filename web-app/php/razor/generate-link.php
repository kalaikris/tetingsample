...
if (isset($_SESSION[$cookie_name])) {
    ...
    if ($users->stmt->rowCount() > 0) {
        ...
        if ($price_data->total_cost > 0) {
            ...
            $customer->name = $input_data->contactName;
            $customer->contact = $input_data->contactNumber;
            $customer->email = $input_data->contactEmail;

            $description = new stdClass;
            $description = $input_data->contactDesc;
            ...
            $razor_pay->customer = $customer;
            $razor_pay->linkdescription = $description;

            $obj = $razor_pay->generateLink();
