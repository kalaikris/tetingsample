...
<body onload="loadDistributorDetail();">
                    ...
                    <div id="services" class="tab-pane fade in active">
                        <div class="service-main-content" id="services1">
                                ...
                                <div class="packages-box">
                                    <div class="package-header">
                                        <div class="service-contnts">
                                            ...
                                            <p>
                                                <img src="asset/choose-service/flight-coin.png" class="flight-coin" alt="coin icon">
                                                <span style="color: #adadad;">
                                                    Earn <span class="coint-set">10 coins</span>
                                                </span>
                                            </p> -->
                                        </div>
                                        <div class="package-type-set">
                                            <div class="package-price-coin-set">
                                                <p><img src="asset/choose-service/rupee.svg" class="rupee-icon" alt="rupee icon"> 1500 per adult</p>
                                                <span class="division">|</span>
                                                <p><img src="asset/choose-service/rupee.svg" class="rupee-icon" alt="rupee icon"> 500 per child</p>
                                            </div>
                                            <div class="price-set">
                                                <p>₹ 1,000</p>
                                            </div>
                                        ...
                                        <div class="box-check">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="hi">
                                        ...
                                        <ul class="pak-note-lists">
                                            <li class="pak-note-list">
                                                <p>Warm welcome at aerobridge/bus gate by Pranaam officer.</p>
                                            </li>
                                            <li class="pak-note-list">
                                                <p>Retrieval and assistance for baggage (max 3 check in bags per porter) from baggage belt till the car parking area.</p>
                                            </li>
                                            <li class="pak-note-list">
                                                <p>Guidance towards respective counters for left luggage/lost luggage facility.</p>
                                            </li>
                                        </ul>
                                        <div class="view-add-cart-set">
                                            <a href="javascript:void(0)">View more</a>
                                            <button class="addcart">Choose Package</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="packages-box">
                                    <div class="package-header">
                                        <div class="service-contnts">
                                            ...
                                            <!-- <span class="division">|</span>
                                            <p>
                                                <img src="asset/choose-service/flight-coin.png" class="flight-coin"
                                                    alt="coin icon">
                                                <span style="color: #adadad;">
                                                    Earn <span class="coint-set">10 coins</span>
                                                </span>
                                        ...
                                        <div class="package-type-set">
                                            <div class="package-price-coin-set">
                                                <p><img src="asset/choose-service/rupee.svg" class="rupee-icon"
                                                        alt="rupee icon"> 750 per adult</p>
                                                <span class="division">|</span>
                                                <!-- <p>
                                                    <img src="asset/choose-service/flight-coin.png" class="flight-coin" alt="coin icon">
                                                    <span>
                                                        Earn <span class="coint-set">15 coins</span>
                                                    </span>
                                                </p> -->
                                                <p><img src="asset/choose-service/rupee.svg" class="rupee-icon" alt="rupee icon"> 500 per child</p>
                                            </div>
                                        ...
                                        <div class="box-check">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="hi1">
                                                <label class="form-check-label " for="hi1">
                                                    Meet and greet
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="hello2">
                                                <label class="form-check-label " for="hello2">
                                                    Porter
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="hello1">
                                                <label class="form-check-label " for="hello1">
                                                    Translators
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="hellos">
                                                <label class="form-check-label " for="hellos">
                                                    Chauffeur
                                                </label>
                                            </div>
                                        </div>
                                        <ul class="pak-note-lists">
                                            <li class="pak-note-list">
                                                <p>All facilities from Silver package</p>
                                            </li>
                                            <li class="pak-note-list">
                                                <p>Dedicated Pranaam officer for assistance from the baggage belt till the car parking area.</p>
                                            </li>
                                            <li class="pak-note-list">
                                                <p>Guidance towards respective counters for left luggage/lost luggage facility.</p>
                                            </li>
                                        ...
                                        <div class="view-add-cart-set">
                                            <a href="javascript:void(0)">View more</a>
                                            <button class="removecart-btn">Choose Package</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="package-added-alert-set">
                                ...
                                <button class="go-to-next-station pak-add-alert-btn">Go To Next Station</button>
                            </div> -->
                        </div>
                    ...
                    <div id="about" class="tab-pane fade">
                        <div class="about-main-content">
                            ...
                            <div class="header-detail-set" id="service-about-photos-div">
                                <h2><span id="about-photos-prefix"></span> Photos</h2>
                                <div class="sample-img-set" id="service-about-photos"></div>
                            </div>
                            
                            <div class="header-detail-set" id="service-about-amenities-div">
                                <h2>Amenities</h2>
                                <div class="amenities-lists" id="service-about-amenities">
                                    <!-- <div class="amenities-list">
                                        <img src="asset/choose-service/departure-gray.svg" class="amenity-icon" alt="icon">
                                        <p>Flight Info</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/drink.svg" class="amenity-icon" alt="icon">
                                        <p>Drinks</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/food.svg" class="amenity-icon" alt="icon">
                                        <p>Food</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/phone.svg" class="amenity-icon" alt="icon">
                                        <p>Phone</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/shower.svg" class="amenity-icon" alt="icon">
                                        <p>Shower</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/wifi.svg" class="amenity-icon" alt="icon">
                                        <p>Wi-Fi</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/smoke.svg" class="amenity-icon" alt="icon">
                                        <p>Smoke Zone</p>
                                    </div>
                                    <div class="amenities-list">
                                        <img src="asset/choose-service/tv.svg" class="amenity-icon" alt="icon">
                                        <p>TV</p>
                                    </div> -->
                                </div>
                            </div>
    ...
    <script>
        ...
        // var calHours = current.getUTCHours()+':'+current.getUTCMinutes(); // add GMT time to local time
        // // var AMPM = "AM";
        // // if (currentHours > 12) {
        // //     AMPM = "PM";
        ...
        function calcGmtCurrentTime(offset) {
            var d = new Date();
            var utc = d.getTime() + (d.getTimezoneOffset() * 60000);
            var nd = new Date(utc + (3600000*offset));
            return nd;
        ...
        function populateData() {
            ...
            globalStationData.forEach(function(stationData, stationKey) {
                ...
                if (stationData.hasOwnProperty('journey_time')) {
                    ...
                    gmtHours =  stationData.gmt_view.substr(0, 3);
                    gmtMinutes =  stationData.gmt_view.substr(4, 2);
                    minConvert = gmtMinutes/60;
                    if(minConvert == '00'){
                        getMinConvert = '.0';
                    }else{
                        getMinConvert = minConvert.toFixed(1);
                        getMinConvert = '.'+getMinConvert.split('.')[1]; 
                    }
                    gmtTime = gmtHours+getMinConvert;
                    travelTime = calcTime(gmtTime)
                        var amrpm = "AM";
                        ...
                        h = (hour<10)? '0':'';
                        newTravelTime = h+hour +':'+ hou[1] + ' ' + amrpm;
                    stationData.journey_time = newTravelTime; //(stationData.journey_date == nextDay)? timeNow: "12:00 AM";
                }
                        ...
                        serviceColData.service_group.forEach(function(serviceGrpData, serviceGrpKey) {
                            ...
                            serviceGrpData.service_array.forEach(function (tempServ) {
                                if (tempServ.isSelected) hasService = `has-service`;
                                        ...
                                        // <img src="asset/completed.svg" alt="Yes">
                ...
                $('.airport_terminal_tabs').append(`<li id="tab-station-${stationKey}" class="${activeness}">
                    <div class="cart-list" data-toggle="tab" href="#terminal${stationKey}">
                        ...
                        <p class="service_date_time"><span class="flight-date-${stationKey}">${stationData.journey_date}</span> <span class="flight-time-${stationKey}">${journeyTime}</span><br/>(GMT ${stationData.gmt_view})</p>
                    </div>
                </li>`);
            ...
            $('.view-service-detail').on('click', function () {
                ...
                $('#service_date_input').data("DateTimePicker").minDate(journeyDate);
        ...
        function addServicesToCart() {
            ...
            if (serviceDate && serviceDate != '' && serviceTime && serviceTime != '') {
                ...
                gmtHours =  globalStationData[selectedDataIndex].gmt_view.substr(0, 3);
                gmtMinutes =  globalStationData[selectedDataIndex].gmt_view.substr(4, 2);
                minConvert = gmtMinutes/60;
                if(minConvert == '00'){
                    getMinConvert = '.0';
                }else{
                ...
                gmtTime = gmtHours+getMinConvert;
                parsedCurrentTime = calcGmtCurrentTime(gmtTime);
                            ...
                            if(globalStationData[selectedDataIndex].service_collection[selectedDataServiceIndex].service_group[selectedDataCollectionIndex].service_array[key].hadChosen) {
                                ...
                                if (adultCount > 0 || childrenCount > 0) {
                                    ...
                                    if(!$('#service-' + selectedDataIndex + '-' + selectedDataServiceIndex + '-' + selectedDataCollectionIndex).hasClass('has-service'))
                                        $('#service-' + selectedDataIndex + '-' + selectedDataServiceIndex + '-' + selectedDataCollectionIndex).addClass('has-service');
                                } else {
                                    swal({
                                        text: "Service should have atleast 1 person !",
                                        icon: "warning",
        ...
        function evalPrice() {
            ...
            // globalStationData[selectedDataIndex].adult_count = adultCount;
            // globalStationData[selectedDataIndex].children_count = childrenCount;
            $('.net-price').each(function() {
                ...
                var addtionalAdultPrice = parseInt($(this).attr('data-price-add-on-adult'));
                var additionalChildrenPrice = parseInt($(this).attr('data-price-add-on-children'));
                var total_amount = 0;
                if (addtionalAdultPrice > 0 && adultCount > 1) {
                    total_amount += (adultPrice + ((adultCount-1) * addtionalAdultPrice));
                } else {
