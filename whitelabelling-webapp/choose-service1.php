                    ...
                    <ul class="product-header-set">
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                <img src="asset/choose-service/close.svg" class="close-modal" alt="close icon" data-dismiss="modal">
                            </a>
                        </li>
                    </ul>
                </div>
...
//                var category_name = stationData.category_name;
//                //console.log(category_name);
//                    if(category_name=='Arrival'){
//                        var nextstationarraylength = stationData.service_collection.length;
//                        //console.log(nextstationarraylength);
//                        if(nextstationarraylength == '0' || category_name == 'Arrival'){
//                           // console.log(stationKey);
//                            $('.go-to-next-station-'+stationKey).addClass('hidden');
//                        }
//                    }
