...
<body onload="loadDistributorDetail();">
            ...
            <div class="container">
                <div class="tab-box">
                    <ul class="nav nav-tabs ser-ab-review-tab">
                        <li class="">
                            <a data-toggle="tab" href="#myself">Website Booking</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#others" class="">Agent Booking</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="asset/choose-service/close-white.svg" class="close-modal" alt="close icon" data-dismiss="modal" style="float:right;">
                ...
                <div class="modal-body">
                    ...
                    <div class="booked-service-details-container">
                        ...
                        <div class="profile-box-cont1 cost-box">
                            ...
                            <div class="cost-text totalConvenienceFee">
                                <h6>Total Convenience Fee</h6>
                                <h5 id="total-convenience-cost"></h5>
                            </div>
                            <div class="cost-text">
    ...
    <!-- Modal verify otp -->	
    <div id="otp_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="examplesTitle" aria-hidden="true" data-backdrop="static">	
    ...
    <div id="view_review" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="asset/choose-service/close-white.svg" class="close close-modal" alt="close icon" data-dismiss="modal" onclick="close_review_modal()">
                    <div class="feedback-form">
                                    ...
                                    if (response.status_code == 200) {
                                        ...
                                        bookingDetailData.order_detail.forEach(function(stationDetail, stationKey) {
                                            ...
                                            stationDetail.order_detail_array.forEach(function(serviceObj, serviceKey) {
                                                categorydis_Amount += parseFloat(serviceObj.discount_amount);
                                                var serviceStatus = '';
                                        ...
                                        if(bookingDetailData.discount_type=='2' && bookingDetailData.coupon_type=='1'){
                                            ...
                                            discount_amount += `<div class="price-summary-details">
                                                                    <p>Discount Amount</p>
                                                                    <p> - ${currency_symbol} ${categorydis_Amount}</p>
                                                                </div>`;
                                        }
                                        ...
                                        var convFeeGST = (bookingDetailData.cf_tax != '0')? `<div class="price-summary-details">
        ...
        function cancelBooking(hasCancellableService) {
            ...
            curBookingDetail.order_detail.forEach(function(stationObj) {
                stationObj.order_detail_array.forEach(function(serviceObj) {
                    cat_dis_amt += parseInt(serviceObj.discount_amount);
                    ...
                    if (serviceObj.can_be_cancelled) {
                        ...
                        totalConvenienceCost += parseFloat(serviceObj.agent_conv_fee);
                        ...
                        maxPlatformFeeTitle = `title="Max : ${currency_symbol} ${cancellationDetail.max_airportzo_fee}"`;
                    ...
                    var conveFee = '';
                    if(isAgent){
                        conveFee +=`<div class="cost-text avail-text">
                                        <p>Convenience Fee</p>
                                        <h6>${currency_symbol} ${serviceObj.agent_conv_fee}</h6>
                                    </div>`
                    }
            ...
            if(isAgent){
                $('#total-convenience-cost').text(`${currency_symbol} ${totalConvenienceCost.toFixed(2)}`);
            } else {
                $('.totalConvenienceFee').css('display', 'none');
            }
