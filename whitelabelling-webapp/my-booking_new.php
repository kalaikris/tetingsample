...
<body onload="loadDistributorDetail();">
                        ...
                        <div class="messaging-container">
                            <div class="message-box">
                                ...
                                <span class="attach-tool--camera">
                                    <input type="file" id="upload-photo" accept="image/*,.pdf" style="display:none;" onchange="image_upload('upload-photo')">
    ...
    <script>
        ...
        function downloadInvoice() {
            var invoicePdf = curBookingDetail.invoice_pdf;
            if (invoicePdf != '') {
                var element = document.createElement('a');
                element.setAttribute('href', invoicePdf);
        ...
        if(dic.sender_id == userToken){
            var div = `<div class='msg-textbox sent-msg-textbox' id=${i}>`;
                            ...
                            div += `<div class='msg sent-msg'>
                                        <p>${dic.message}</p>
                                        <p class='chat-time'>${dic.date_time.toDate().toDateString()}</p>
                                    </div>`;
