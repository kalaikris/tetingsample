    ...
    public function genInvoiceForCancel() {
        ...
        $invoice_html = '<table style="width:100%" cellspacing="0" cellpadding="0">
                    <thead style="bgcolor: #fbfbfb;">
                        <tr>
                            <th style="width:66%">
                                <img src="' . $this->invoice_obj->header_logo . '" alt="logo" style="width:200px">
                            </th>
                            <th style="">
                                <span>
                                ...
                                <br>
                                <span>
                                    <span style="font-size:14px;">Invoice No : ' . $this->invoice_token . '</span>
                                </span>
                                <br>
                                <span>
                                    <span style="font-size:14px;">Date : ' . $this->cancelled_date . '</span>
                                </span>
                            </th>
                        </tr>
                        <tr>
                                        ...
                                        <table style="width:100%;" border="0" cellspacing="0" cellpadding="4">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width:34%;font-size: 11px;border-bottom:2px solid #f2f2f2;">
                                                        <br>
                                                        <b>DESCRIPTION</b>
                                                    </th>
                                                    <th style="width:20%;font-size: 11px;height:25px;border-bottom:2px solid #f2f2f2;">
                                                        <br>
                                                        <b>TAXABLE REFUND VALUE</b>
                                                    </th>
                                                    <th style="width:20%;font-size: 11px;text-align:center;height:25px;border-bottom:2px solid #f2f2f2;">
                                                        <br>
                                                        <b>GST</b>
                                                    </th>
                                                    <th style="width:20%;font-size: 11px;text-align:center;border-bottom:2px solid #f2f2f2;">
                                                        <br>
                                ...
                                if ($service_value->token == $this->order_detail_token && $service_value->can_be_cancelled){
                                        $invoice_html .= '<tr>
                                                            ...
                                                            <td style="text-align:center;">
                                                                <tr>
                                                                    <td>
                                                                        <span style="font-size: 12px;">' . $service_value->cancellation_detail->refund_amount . '</span>
                                                                        <br><br>
                                                                    </td>
                                                                </tr>
                                                            </td>
