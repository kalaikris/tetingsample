    ...
    public function genInvoiceForOrder() {
        ...
        $invoice_html = '<table style="width:100%" cellspacing="0" cellpadding="0">
                    ...
                    $invoice_html .= '</span>
                            ...
                            <th style="width:28%">
                                <div><span style=""><span style="font-size: 17px;">Sold by:</span><br><span style=""><span style="font-size:13px;">' . $company_names . '</span></span><br><span style="font-size:13px;">' . $address . '</span>';
                                        // <span style="">
                                        ...
                                        // </span>
                                        // <br>
                    $invoice_html .= '<br><span style=""><span style="font-size:13px;">PAN NO : ' . $pan_no . ',</span></span><br><span style=""><span style="font-size:13px;">GST Registration No : '.$gst_nos.'</span></span><br><span style=""><span style="font-size:13px;">UT code : '.$ut_codes.'</span>
                                        </span>
                                    </span>
                                </div>
                            </th>
                                                ...
                                                <td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($tax_types == '2'){
                                                            ...
                                                            $invoice_html .= '<tr>
                                                                                <td style="width:50%;line-height:25px;text-align:left;">
                                                                                    <span style="font-size: 12px;">18% IGST on convenience fee</span>
                                                                                </td>
                                                                                <td style="width:40%;text-align:right;line-height:25px;">
